...
void main()
{
    ...
    u_xlat2.zw = u_xlat0.xx * u_xlat2.xx + vec2(-0.5, -0.5);
...
void main()
{
    ...
    u_xlat12 = u_xlat12 * abs(u_xlat7);
    u_xlat15 = u_xlat15 * u_xlat2.x + (-u_xlat12);
    u_xlat10.x = abs(u_xlat10.x) * u_xlat15 + u_xlat12;
    u_xlatb15 = hlslcc_mtx4x4glstate_matrix_projection[3].w==0.0;
    u_xlat10.x = (u_xlatb15) ? u_xlat10.x : u_xlat7;
    u_xlat15 = _OutlineSoftness * _ScaleRatioA;
    u_xlat15 = u_xlat15 * u_xlat10.x + 1.0;
    u_xlat2.x = u_xlat10.x / u_xlat15;
    u_xlat10.x = _OutlineWidth * _ScaleRatioA;
    u_xlat10.x = u_xlat2.x * u_xlat10.x;
    u_xlat10.x = min(u_xlat10.x, 1.0);
    u_xlat10.x = sqrt(u_xlat10.x);
    u_xlat15 = in_COLOR0.w * _OutlineColor.w;
    u_xlat4.xyz = _OutlineColor.xyz * vec3(u_xlat15) + (-u_xlat16_3.xyz);
    u_xlat4.w = _OutlineColor.w * in_COLOR0.w + (-u_xlat16_3.w);
    u_xlat3 = u_xlat10.xxxx * u_xlat4 + u_xlat16_3;
    vs_COLOR1 = u_xlat3;
    u_xlat3 = max(_ClipRect, vec4(-2e+10, -2e+10, -2e+10, -2e+10));
    u_xlat3 = min(u_xlat3, vec4(2e+10, 2e+10, 2e+10, 2e+10));
    ...
    u_xlat0.x = u_xlat0.x * _ScaleRatioA;
    u_xlat0.x = (-u_xlat0.x) * 0.5 + 0.5;
    u_xlat2.yzw = u_xlat0.xxx * u_xlat2.xxx + vec3(-0.5, -0.5, -0.5);
    vs_TEXCOORD1 = u_xlat2;
    return;
}
