...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat10_0.xyz * _TintColor.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat10_1.xyz * _TintColor.xyz;
    u_xlat16_11 = (-u_xlat10_1.w) + 1.0;
    u_xlat16_2.xyz = u_xlat0.xyz * u_xlat16_2.xyz;
    u_xlat0.x = dot(_TintColor.ww, u_xlat0.ww);
    u_xlat0.w = u_xlat0.x * u_xlat16_11;
    u_xlat0.xyz = u_xlat16_2.xyz + u_xlat16_2.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_1.xyz * _TintColor.xyz;
