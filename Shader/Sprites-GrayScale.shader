...
void main()
{
    ...
    u_xlat1.xyz = vec3(_GrayscaleAmount) * u_xlat0.xyz + u_xlat1.xyz;
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat0.xyz = (-u_xlat10_0.xyz) * vs_COLOR0.xyz + vec3(u_xlat9);
    u_xlat1.xyz = vec3(_GrayscaleAmount) * u_xlat0.xyz + u_xlat1.xyz;
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat1 = u_xlat16_0 * vs_COLOR0;
    u_xlat9 = dot(u_xlat1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat0.xyz = (-u_xlat16_0.xyz) * vs_COLOR0.xyz + vec3(u_xlat9);
    u_xlat1.xyz = vec3(_GrayscaleAmount) * u_xlat0.xyz + u_xlat1.xyz;
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat9 = dot(u_xlat1.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat0.xyz = (-u_xlat10_0.xyz) * vs_COLOR0.xyz + vec3(u_xlat9);
    u_xlat0.xyz = vec3(_GrayscaleAmount) * u_xlat0.xyz + u_xlat1.xyz;
...
;
    ...
    u_xlat1.xyz = (-u_xlat10_1.xyz) * vs_COLOR0.xyz + vec3(u_xlat13);
    u_xlat0.xyz = vec3(_GrayscaleAmount) * u_xlat1.xyz + u_xlat2.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
;
    ...
    if(u_xlatb13){discard;}
    u_xlat13 = dot(u_xlat2.xyz, vec3(0.300000012, 0.589999974, 0.109999999));
    u_xlat1.xyz = (-u_xlat16_1.xyz) * vs_COLOR0.xyz + vec3(u_xlat13);
    u_xlat0.xyz = vec3(_GrayscaleAmount) * u_xlat1.xyz + u_xlat2.xyz;
    SV_Target0 = u_xlat0;
    return;
}
